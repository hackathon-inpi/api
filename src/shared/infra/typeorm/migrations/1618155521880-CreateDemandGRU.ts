...
export class CreateDemandGRU1618155521880 implements MigrationInterface {
    name = 'CreateDemandGRU1618155521880'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "protocol_gru" ("id" SERIAL NOT NULL, "status" character varying NOT NULL, "date" TIMESTAMP NOT NULL, "price" float NOT NULL, "barCode" character varying NOT NULL, "user_id" integer, CONSTRAINT "PK_d7c4b22f98928e54fcbccabe020" PRIMARY KEY ("id"))`);
